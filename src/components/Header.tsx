...
export default function Header({ 
  ...
  return (
    <header className="w-full bg-white sticky top-0 z-50 font-sans border-b border-slate-200">
      ...
      {/* Main Header Row */}
      <div className="w-full bg-white text-slate-900 py-3 px-0 border-b border-slate-200">
        <div className="w-full mx-auto flex flex-col md:flex-row items-center justify-between gap-4 px-4 sm:px-6 lg:px-8">
      ...
      <div className="hidden lg:block w-full bg-[#002d5b] border-t border-[#002d5b]">
        <div className="w-full mx-auto flex w-full text-white relative z-40 flex-wrap justify-between px-4 sm:px-6 lg:px-8">
          {dbCategories.map((cat) => {
