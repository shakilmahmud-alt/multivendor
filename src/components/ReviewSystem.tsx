        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
            ...
            <form onSubmit={handleSubmitReview} className="space-y-3 text-[11px] font-medium text-slate-705">
              <div>
                ...
                <input 
                  ...
                  className="w-full p-2 bg-slate-50 border border-slate-200 rounded outline-none focus:border-brand-500"
                />
              </div>
              ...
              <div>
                ...
                <textarea 
                  ...
                  className="w-full p-2 bg-slate-50 border border-slate-200 rounded outline-none focus:border-brand-500 min-h-[60px]"
                />
              </div>

              <button 
                type="submit"
                className="w-full bg-slate-900 text-white hover:bg-brand-500 font-bold py-2 rounded transition text-center cursor-pointer text-xs"
              >
                Post Buyer Review
              </button>
            </form>
          ...
          <div className="lg:col-span-2">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              {reviews.map((r) => (
                <div key={r.id} className="bg-white rounded border border-slate-200 p-3 shadow-xs flex flex-col justify-between hover:border-brand-400 transition duration-150">
                  <div>
                  ...
                  <div className="mt-3.5 pt-2 border-t border-slate-100 flex items-center justify-between text-[9px] text-slate-400">
                    ...
                    <button className="flex items-center gap-0.5 hover:text-brand-500 transition cursor-pointer">
