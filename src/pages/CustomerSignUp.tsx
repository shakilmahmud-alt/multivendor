      ...
      <div className="bg-white w-full max-w-3xl rounded-xl shadow-sm border border-slate-200 p-8 md:p-12">
        ...
        <div className="flex justify-center mb-8 gap-2">
          <button 
            ...
            className={`px-6 py-2.5 text-sm font-medium transition ${signupMethod === 'mobile' ? 'bg-brand-500 text-white rounded shadow-sm' : 'bg-slate-50 text-brand-500 rounded hover:bg-slate-100'}`}
          >
            Sign up with Mobile
          </button>
          <button 
            onClick={() => setSignupMethod('email')}
            className={`px-6 py-2.5 text-sm font-medium transition ${signupMethod === 'email' ? 'bg-brand-500 text-white rounded shadow-sm' : 'bg-slate-50 text-brand-500 rounded hover:bg-slate-100'}`}
          >
            Sign up with Email
          </button>
        </div>
              ...
              {signupMethod === 'mobile' ? (
                <>
                  <label className="block text-sm font-bold text-slate-700 mb-2">
                    Phone Number <span className="text-brand-500 text-[11px] font-normal">(* Country Code Is Must Like For BD 880)</span>
                  </label>
                  <input 
                    type="text" 
                    name="phone"
